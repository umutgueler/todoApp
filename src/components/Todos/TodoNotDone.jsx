...
const TodoNotDone = ({ todo }) => {
    ...
    return (
        <AnimatePresence>
            ...
            >
                <div
                    className={(!isVisibleContent ? "lg:hover:from-pink-600 lg:hover:to-blue-600 from-white" : "from-pink-500") + " group p-4 flex flex-col lg:flex-row lg:justify-between lg:items-center bg-gradient-to-r  to-blue-600 cursor-pointer"}
